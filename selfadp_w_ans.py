...
def main():
    ...
    if "Llama-3" in args.model_name:
        prefix_len = len(tokenizer.decode(128006) + tokenizer.decode(78191) + tokenizer.decode(128007) + tokenizer.decode(271))
        res = [i[prefix_len:] for i in res]
    ...
    for ind, batch in enumerate(dataloader):
        ...
        if "Llama-3" in args.model_name:
            response_prefix = tokenizer.decode(78191) + tokenizer.decode(271)
